...
class ManageCourtService {
  // [UBAH DI SINI]
  // Karena pakai Chrome & Local, gunakan https://tristan-rasheed-court-finder.pbp.cs.ui.ac.id
  ...
  Future<Map<String, dynamic>> fetchCourtConstants(
  ...
  Future<Map<String, dynamic>> editCourt(
    CookieRequest request,
    int id,
    Map<String, dynamic> data,
  ) async {
