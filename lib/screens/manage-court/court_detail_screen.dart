                ...
                Padding(
                  ...
                  child: ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: (widget.court.photoUrl != null && widget.court.photoUrl!.isNotEmpty)
                          ? Image.network(
                              widget.court.photoUrl!.startsWith('http') 
                                  ? widget.court.photoUrl! 
                                  : 'http://127.0.0.1:8000${widget.court.photoUrl}', 
                              fit: BoxFit.cover,
                              errorBuilder: (ctx, err, stack) => _buildNoImage(),
                            )
                          : _buildNoImage(),
                    ),
                  ),
                      ...
                      widget.court.facilities.isEmpty
                          ...
                          : Wrap(
                              ...
                              children: List.generate(
                                ...
                                (index) {
                                  final facilId = widget.court.facilities[index];
                                  return Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      boxShadow: [
                                        BoxShadow(
                                          color: _getFacilityColor(index).withOpacity(0.3),
                                          blurRadius: 4,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      Text(
                        (widget.court.description != null && widget.court.description!.isNotEmpty) 
